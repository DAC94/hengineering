        ...
        <div className="bg-white p-6 sm:p-8 rounded-lg border border-slate-200 shadow-sm border-t-4 border-t-amber-500 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-8 space-y-4">
            ...
            <div className="p-4 bg-slate-50 rounded border border-slate-200 text-xs text-slate-700 space-y-2 font-mono">
              <p><strong className="text-[#154c76] font-serif-guild">Arms (Blazon):</strong> Azure, a chevron Gules between two brass plumb-bobs in chief and a sarsen stone trilithon in base Or.</p>
              <p><strong className="text-[#154c76] font-serif-guild">Crest:</strong> Upon a helm with a torse Or and Azure, a Salisbury Great Bustard statant proper, holding in its beak a mason's stone chisel Or.</p>
